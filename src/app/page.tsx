          ...
          <section className="space-y-3">
            ...
            {data.results.map((hike) => (
              ...
              >
                ...
                {hike.summary && (
                  <p className="mt-3 text-sm text-slate-700">{hike.summary}</p>
                )}

                <div className="mt-3 grid gap-2 text-xs text-slate-700 sm:grid-cols-2">
                  <div>
                    <strong>Route distance:</strong> {hike.distance_km} km
                    <br />
                    <strong>From postcode:</strong>{' '}
                    {hike.distanceFromPostcodeKm} km
                    {hike.estimated_time_hours && (
                      <>
                        <br />
                        <strong>Estimated time:</strong>{' '}
                        {hike.estimated_time_hours} hours
                      </>
                    )}
                  </div>
                  <div>
                    ...
                    {typeof hike.ascent_meters === 'number' && (
                      <>
                        <strong>Total ascent:</strong> {hike.ascent_meters} m
                        <br />
                      </>
                    )}
